...
export default function Terms() {
  return (
    <section className="relative overflow-hidden bg-white">
      ...
      {/* Content */}
      <div className="relative z-10 mx-auto w-[90%] max-w-4xl py-20">
        ...
        <div className="space-y-5 text-black/80 leading-relaxed">
          <div>
            <h2 className="mb-1 text-xl font-medium">Use of Website</h2>
            <p>
          ...
          <div>
            <h2 className="mb-1 text-xl font-medium">Intellectual Property</h2>
            <p>
          ...
          <div>
            <h2 className="mb-1 text-xl font-medium">Services & Engagements</h2>
            <p>
          ...
          <div>
            <h2 className="mb-1 text-xl font-medium">Limitation of Liability</h2>
            <p>
          ...
          <div>
            <h2 className="mb-1 text-xl font-medium">Changes to Terms</h2>
            <p>
          ...
          <div>
            <h2 className="mb-1 text-xl font-medium">Contact</h2>
            <p>
